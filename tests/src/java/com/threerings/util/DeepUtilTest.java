...
public class DeepUtilTest extends TestCase
{
    ...
    public void testCopy ()
    {
        ...
        float[][] v2 = new float[RandomUtil.getInt(10, 5)][RandomUtil.getInt(10, 5)];
    ...
    public void testEquals ()
    {
        ...
        byte[] v4 = new byte[RandomUtil.getInt(10, 5)];
    ...
    protected class Child extends Parent
    {
        ...
        public void randomize ()
        {
            ...
            v3 = new Object[RandomUtil.getInt(20, 10)][];
            for (int ii = 0; ii < v3.length; ii++) {
                if (RandomUtil.rand.nextBoolean()) {
                    continue;
                }
                v3[ii] = new Object[RandomUtil.getInt(20, 10)];
                for (int jj = 0; jj < v3[ii].length; jj++) {
                    if (RandomUtil.rand.nextBoolean()) {
                        continue;
                    }
